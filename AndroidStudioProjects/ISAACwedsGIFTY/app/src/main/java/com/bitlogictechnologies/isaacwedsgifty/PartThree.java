...
public class PartThree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.part_three_ui);
    ...
    private void prepareListData() {
        ...
        final String[] refOrder=part1Data.part3_main;

        // Adding word data
        listWordHeader.add("Refreshments");
        ...
        for(int count=0;count<refOrder.length;count++){
            String nos=Integer.toString(count + 1)+".\t";
            a1.add(count, nos + refOrder[count]);
        }
