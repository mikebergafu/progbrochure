...
public class PartTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.part_two_ui);
    ...
    private void prepareListData() {
        ...
        final String[] photoOrder=part1Data.photo_order;

        // Adding word data
        listWordHeader.add("Order of Photograph\n Bride and Groom with:");
        ...
        for(int count=0;count<photoOrder.length;count++){
            String nos=Integer.toString(count + 1)+".\t";
            a1.add(count, nos + photoOrder[count]);
        }
